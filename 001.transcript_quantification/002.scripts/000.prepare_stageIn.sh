...
PROJECTS=/groups/nordborg/projects/cold_adaptation_16Cvs6C/003.transcriptome/001.8accessions/
WORK=/scratch-cbe/users/pieter.clauw/cold_adaptation_16Cvs6C/003.transcriptome/001.8accessions/

rsync -a --include '*/' --exclude '*' "$PROJECTS" "$WORK"

# copy VCF to scratch
cp -up /groups/nordborg/projects/the1001genomes/release/VCFs/1001genomes_snp-short-indel_only_ACGTN.vcf.gz /scratch-cbe/users/pieter.clauw/cold_adaptation_16Cvs6C/003.transcriptome/001.8accessions/001.transcript_quantification/001.data/001.vcf/
