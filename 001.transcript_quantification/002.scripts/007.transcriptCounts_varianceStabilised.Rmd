...
as_tibble(t(assay(dds.varStab)), rownames = 'sample') %>%
  ...
  write_csv('/groups/nordborg/projects/cold_adaptation_16Cvs6C/003.transcriptome/001.8accessions/001.transcript_quantification/003.results/transcriptCounts_varianceStabilised.csv')
